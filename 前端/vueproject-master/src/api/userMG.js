...
// 登录接口 login(params)
export const login = (params) => { return loginreq("post", "/api/user-web/user/login", params) };
// 获取用户菜单
 ...
 **/
// 用户管理-删除用户
export const getUserById = (params) => { return axios.post( 
    "/api/user-web/user/getUserById?id=" + params).then(res =>
    res.data) };
// 用户管理-获取用户列表
export const userList = (params) => { return req("post", "/api/user-web/user/getAllUser", params) };
export const getUserByLike=(params)=>{return req("post", "/api/user-web/user/getUserByLike", params)}
// 用户管理-保存（添加编辑）
export const userSave = (params) => { return req("post", "/api/user-web/user/addOrUpdateUser", params) };
// 用户管理-删除用户
export const userDelete = (params) => { return axios.delete("/api/user-web/user/deleteById?id=" + params).then(res => res.data) };
// 用户管理-重置密码
 ...
 **/
// 角色管理-获取角色列表
export const roleList = (params) => { return req("post", "/api/user-web/role/getAllRole", params) };
// 角色管理-保存（添加编辑）
...
// 部门管理-保存（添加编辑）
export const deptSave = (params) => { return req("post", "/api/prodcut/saveProduct", params) };
// 部门管理-删除部门
export const deptDelete = (params) => { return axios.get("/api/product/deleteProduct?ids=" + params + "&token=" + localStorage.getItem('logintoken')).then(res => res.data) };
